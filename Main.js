//GO TO README.md
//THIS FILE IS A COPY OF THE FILE POSTED IN README, I WOULD PEFER YOU USE THAT FILE AS THIS IS IN CASE THAT ONE GOES DOWN.

//FILE IS BASED OFF OF COMPACTS COW UI HOWEVER WITH A NEW INTEGRATEAD METHOD OF BLOCKING EXTENTIONS.

//Made by @Mrnuke, @mrnuke000
//4.19.23
//UI is based off of Compacts Cow UI:

go();
function go(){const style = document.createElement("style");
